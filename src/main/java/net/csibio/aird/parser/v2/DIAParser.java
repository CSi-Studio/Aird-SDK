...
public class DIAParser extends BaseParser {
   ...
   */
  public Spectrum getSpectrumByRt(long startPtr, List<Float> rtList, List<Long> mzSizeList,
   ...
   * @return 某个时刻的光谱信息 the spectrum of the target retention time
   */
  public Spectrum getSpectrumByIndex(long startPtr, List<Long> mzSizeList, List<Long> intSizeList,
      int index) {
    try {
      long start = startPtr;
