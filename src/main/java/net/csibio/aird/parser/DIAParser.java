...
public class DIAParser extends BaseParser {
     ...
     */
    public TreeMap<Float, Spectrum<double[], float[], double[]>> getSpectra(BlockIndex index) {
     ...
     * @return all the spectrums
     */
    public TreeMap<Float, Spectrum<float[], float[], float[]>> getSpectraAsFloat(BlockIndex index) {
