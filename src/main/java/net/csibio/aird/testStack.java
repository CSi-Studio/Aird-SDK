...
//        }whether git is ready.
        ...
        int testBlockNum = 1;
        long[][] record = new long[9][testBlockNum];
...
//            System.out.println("原数组：" + size1);
            ...
            for (int i = 0; i < mzNum; i++) {
                ...
                t2 += (System.currentTimeMillis() - tempT);
            }
...
//                System.out.println("二代压缩时间：" + (t3 - t2));
        ...
        out.write("sizeOrigin,size1,encodeTime1,decodeTime1,size2,encodeTime2,decodeTime2,sizeIndex,sizeMz\r\n");
