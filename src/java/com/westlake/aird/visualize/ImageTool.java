...
public class ImageTool {
    ...
    public static void scanToImage(String fileName, float[] mz, float[] intensity) throws IOException {
    ...
    public static float[][] imageToScan(String fileName) throws IOException {
