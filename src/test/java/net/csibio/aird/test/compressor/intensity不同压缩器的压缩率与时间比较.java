...
//        -1);
    ...
    private static void initFile(String name, String indexPath, AirdType type, int indexNo) throws Exception {
        ...
        switch (type) {
            case DIA -> {
                ...
                precision = parser.getAirdInfo().fetchCompressor(Compressor.TARGET_INTENSITY).getPrecision();
    ...
    public void test_DIA() {
        spectrumListMap.forEach((key, value) -> {
            System.out.println("开始测试文件:" + key + "包含光谱共" + spectrumIntsMap.get(key).size() + "张,-------------------------");
...
//      test_LZMA2(bytesList);
    ...
    private void test_brotli(List<byte[]> bytesList) {
        ...
        System.out.println("Brotli:" + (System.currentTimeMillis() - start) + "|" + compressedSize.get() / MB + "M");
    }
    ...
    private void test_zlib(List<byte[]> bytesList) {
        ...
        System.out.println("Zlib:" + (System.currentTimeMillis() - start) + "|" + compressedSize.get() / MB + "M");
    }
    ...
    private void test_snappy(List<byte[]> bytesList) {
        ...
        System.out.println("Snappy:" + (System.currentTimeMillis() - start) + "|" + compressedSize.get() / MB + "M");
    }
    ...
    private void test_zstd(List<byte[]> bytesList) {
        ...
        System.out.println("ZSTD:" + (System.currentTimeMillis() - start) + "|" + compressedSize.get() / MB + "M");
    }
    ...
    private void test_xdpd2_zlib(List<int[]> intsList) {
        ...
        System.out.println("XDPD2-Zlib:" + (System.currentTimeMillis() - start) + "|" + compressedSize.get() / MB + "M");
    }
    ...
    private void test_xdpd2_brotli(List<int[]> intsList) {
        ...
        System.out.println("XDPD2-Brotli:" + (System.currentTimeMillis() - start) + "|" + compressedSize.get() / MB + "M");
    }
    ...
    private void test_xdpd2_snappy(List<int[]> intsList) {
        ...
        System.out.println("XDPD2-Snappy:" + (System.currentTimeMillis() - start) + "|" + compressedSize.get() / MB + "M");
    }
    ...
    private void test_xdpd2_zstd(List<int[]> intsList) {
        ...
        System.out.println("XDPD2-ZSTD:" + (System.currentTimeMillis() - start) + "|" + compressedSize.get() / MB + "M");
    }
